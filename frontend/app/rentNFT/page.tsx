...
const NFTcontractAddress = "0x15da21C1A652E582f9adAD7d728fDf4ED3232770";
const listNFTcontractAddress = "0x1275D096B9DBf2347bD2a131Fb6BDaB0B4882487";
...
export default function AvailableNFTs() {
  ...
  async function loadAvailableNFTs() {
    ...
    try {
      ...
      const [tokenIds, owners, prices] = await listNFTContract.getAvailableNFTs();
    ...
    <div className="p-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 flex flex-col items-center">
          <motion.h1 
            className="text-4xl font-bold text-center mb-2 text-yellow-400 drop-shadow-lg"
          ...
          <motion.p 
            className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto text-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="mt-4 text-blue-400 font-semibold">Loading available NFTs...</p>
          </div>
        )}
        ...
        {!loading && availableNFTs.length === 0 && (
          <div className="text-center py-20 bg-gray-800 rounded-lg border border-gray-700 shadow-xl">
            ...
            <h3 className="text-xl font-bold mb-2">No NFTs available for rent</h3>
            <p className="text-gray-400 mb-6">Check back later or list your own NFTs for rent</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {availableNFTs.map((nft, index) => {
              ...
              return (
                <motion.div 
                  key={nft.tokenId}
                  className={`bg-gray-800 rounded-lg overflow-hidden border-2 ${rarityBorder} transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-1`}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-center text-blue-300">
                        ...
                        <span className="font-mono">{nft.pricePerHour} ETH / hour</span>
                      </div>
                      
                      <div className="flex items-center text-blue-200 text-sm truncate">
                        <HiClock className="mr-2 flex-shrink-0" />
                        <span className="truncate">Owner: {nft.owner.slice(0, 6)}...{nft.owner.slice(-4)}</span>
                      </div>
                    </div>
                    ...
                    <button 
                      ...
                      className="w-full mt-4 bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition duration-200 text-sm font-bold shadow-md flex items-center justify-center"
                    >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    value={hoursToRent}
                    onChange={(e) => setHoursToRent(parseInt(e.target.value) || 1)}
                ...
                <div className="bg-gray-700 rounded-md p-3">
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-mono font-medium text-white">
                      {(parseFloat(selectedNft.pricePerHour) * hoursToRent).toFixed(6)} ETH
                    </span>
                  </div>
                  <div className="text-xs text-gray-400">
                    NFT will be returned automatically after the rental period ends
                  </div>
                </div>
              </div>
            </div>
